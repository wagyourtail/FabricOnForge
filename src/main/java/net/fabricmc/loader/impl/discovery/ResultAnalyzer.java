...
import net.fabricmc.loader.api.version.VersionComparisonOperator;
import net.fabricmc.loader.api.version.VersionPredicate;
...
final class ResultAnalyzer {
	...
	private static String getDependencyVersionRequirements(ModDependency dependency) {
		...
		for (VersionPredicate predicate : predicates) {
			...
			Collection<? extends VersionPredicate.PredicateTerm> terms = predicate.getTerms();
			...
			for (VersionPredicate.PredicateTerm term : terms) {
